...
import { postsAPI, snapchatAPI, authAPI } from '@/lib/api';
...
export default function DashboardPage() {
  ...
  const fetchData = async () => {
    try {
      const [analyticsRes, snapchatRes, userRes] = await Promise.all([
        ...
        <div className="container mx-auto p-6">
          ...
          {!snapchatStatus?.isConnected && (
            <div className="alert alert-warning mb-6">
              ...
              <span>Connect your Snapchat account to start publishing</span>
